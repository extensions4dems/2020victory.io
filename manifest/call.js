...
// looks for a term code(s).
// needs to run after native code executes so just keep checking after each click
//TODO: ends up firing twice per click, probably needs to filter on source to just run once
document.addEventListener("click",
    function() {
        // wait a bit after the click so the native code has a chance to run
    	setTimeout( function() {
